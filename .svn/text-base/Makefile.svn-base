...
LFLAGS = -L. -L/opt/x11/lib -L/usr/local/lib/boost -lX11
LFLAGS_LIB_STREETSDATABASE = -lboost_serialization -lstreetsdatabase -lX11
LFLAGS_LIB_STREETMAP = -lstreetmap -lX11 -lreadline
...
$(LIB_STREETMAP_TEST): $(LIB_STREETMAP_TEST_OBJ) $(LIB_STREETMAP) $(LIB_STREETSDATABASE)
	$(CXX) $(CFLAGS) $^ $(LFLAGS) $(LFLAGS_LIB_STREETSDATABASE) $(LFLAGS_LIB_STREETMAP) $(GRAPHICS_LIBS) -lunittest++ -o $@
