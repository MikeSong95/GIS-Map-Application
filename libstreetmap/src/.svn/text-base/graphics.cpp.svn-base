...
#define MWIDTH		120 /* Width of menu window */
 ...
 */
#define FONT_CACHE_SIZE_FOR_ZEROS 10000
...
#define ZOOM_FACTOR  1.5 /* For zooming on the graphics */
#endif
...
void create_button(const char *prev_button_text, const char *button_text,
    ...
    i = bnum;
    button_state.button[i].xleft = 10;
    ...
    button_state.button[i].width = 100;
...
build_default_menu(void) {
    ...
    const int NUM_ARROW_BUTTONS = 0, NUM_STANDARD_BUTTONS = 5, SEPARATOR_BUTTON_INDEX = 8;
    t_color defaultMenuColor;
    defaultMenuColor.blue = 128;
    defaultMenuColor.red = 128;
    defaultMenuColor.green = 128;
    ...
    x11_state.menu = XCreateSimpleWindow(
        ...
        x11_convert_to_xcolor(defaultMenuColor),
        x11_convert_to_xcolor(defaultMenuColor)
        );
   ...
   // }
    ...
    strcpy(button_state.button[0].text, "Zoom Fit");
    strcpy(button_state.button[1].text, "Window");
    strcpy(button_state.button[2].text, "Screenshot");
    strcpy(button_state.button[3].text, "Load New Map");
    strcpy(button_state.button[4].text, "Exit");
    
    button_state.button[0].fcn = zoom_fit;
    button_state.button[1].fcn = adjustwin;
    button_state.button[2].fcn = postscript;
    button_state.button[3].fcn = proceed; // see 'adjustButton' below in WIN32 section
    button_state.button[4].fcn = quit;
