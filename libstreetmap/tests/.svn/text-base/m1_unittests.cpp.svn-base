...
SUITE(M1_Public_Functionality_Tests) {
	TEST_FIXTURE(Map_Fixture, intersection_name_functionality) {
		...
		CHECK_EQUAL(73004, find_intersection_id_from_name("University Avenue & Wellington Street West"));
                ...
                // ERROR CHECKING
                CHECK_EQUAL(999999999, find_intersection_id_from_name("Fake Intersection Name"));
                CHECK_EQUAL(999999999, find_intersection_id_from_name("University Avenue & Wellington Street Wes")); // a letter deleted
        }
	...
	TEST_FIXTURE(Map_Fixture, street_name_functionality) {
		...
		CHECK_EQUAL(683, find_street_id_from_name("McCowan Road"));
                ...
                // ERROR CHECKING
                CHECK_EQUAL(999999999, find_street_id_from_name("Fake Street Name"));
                CHECK_EQUAL(999999999, find_street_id_from_name("McCowan Roa")); // a letter deleted
	}
	...
	TEST_FIXTURE(Map_Fixture, intersection_name_street_segments_functionality) {
		...
		CHECK_EQUAL(expected_result, result);
                ...
                result = find_intersection_street_segments("Fake Intersection");
                CHECK_EQUAL(expected_result, result);
                
                expected_result = {999999999};
                result = find_intersection_street_segments("University Avenue & Wellington Street Wes");
                CHECK_EQUAL(expected_result, result);
	}
	...
	TEST_FIXTURE(Map_Fixture, intersection_id_street_segments_functionality) {
		...
		CHECK_EQUAL(expected_result, result);
                ...
                // ERROR CHECKING
                expected_result = {999999999};
                result = find_intersection_street_segments(999999999);
                CHECK_EQUAL(expected_result, result);
	}
	...
	TEST_FIXTURE(Map_Fixture, intersection_name_street_names_functionality) {
		...
		CHECK_EQUAL(expected_result, result);
                ...
                // ERROR CHECKING
                expected_result = {"Fake Street Name"};
                result = find_intersection_street_names("Fake Intersection Name");
                CHECK_EQUAL(expected_result, result);
	}
	...
	TEST_FIXTURE(Map_Fixture, closest_poi_functionality) {
        ...
        TEST_FIXTURE(Map_Fixture, find_intersection_street_names_functionality) {
            ...
            result = find_intersection_street_names("Spadina Avenue & Harbord Street");
            expected_result = {"Harbord Street", "Spadina Avenue"};
            CHECK_EQUAL(expected_result, result);
            
            result = find_intersection_street_names("Harbord Street & Major Street");
            expected_result = {"Harbord Street", "Major Street"};
            CHECK_EQUAL(expected_result, result);
            
            result = find_intersection_street_names("Carlton Street & Jarvis Street");
            expected_result = {"Carlton Street", "Jarvis Street"};
            CHECK_EQUAL(expected_result, result);
        }
        
        TEST_FIXTURE(Map_Fixture, find_intersection_street_names_from_id_functionality) {
            std::vector<std::string> result; 
            std::vector<std::string> expected_result;
            
            result = find_intersection_street_names(5438);
            expected_result = {"Dundas Street West", "University Avenue"};
            CHECK_EQUAL(expected_result, result);
            ...
            result = find_intersection_street_names(9877);
            expected_result = {"Harbord Street", "Spadina Avenue"};
            CHECK_EQUAL(expected_result, result);
            
            result = find_intersection_street_names(2123);
            expected_result = {"Harbord Street", "Major Street"};
            CHECK_EQUAL(expected_result, result);
            
            result = find_intersection_street_names(45978);
            expected_result = {"Carlton Street", "Jarvis Street"};
            CHECK_EQUAL(expected_result, result);
        }
}
